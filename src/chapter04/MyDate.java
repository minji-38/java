 ...
 * 
 * Encapsulation(캡슐화)
 * 	- 대부분의 속성과 일부 메소드를 private, default(생략), protected를 이용해서 캡슐로 싸는 기술
 * 	- 목적
 * 		1. 보호
 * 		2. 은닉 ==> 수정성 용이 (유지보수성을 높임. === decouple 효과로 인해)
 * 	- 접근 할 수 있는 public 한 메서드 (getter, setter)를 제공해야 한다.
 */
public class MyDate {
	...
	public void setYear(int year) {
		if (year<=2024) { //프로그램의 의도에 맞게 예외처리해주기
